...
ActiveRecord::Schema.define(version: 20160621142153) do
  ...
  create_table "managed_pages", force: :cascade do |t|
    t.integer  "user_id"
    t.string   "title"
  ...
  add_index "managed_pages", ["user_id"], name: "index_managed_pages_on_user_id", using: :btree
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.string   "uid"
    t.string   "fb_token"
    t.string   "fb_token_expires"
    t.string   "full_name"
    t.string   "fb_profile_image"
  end
